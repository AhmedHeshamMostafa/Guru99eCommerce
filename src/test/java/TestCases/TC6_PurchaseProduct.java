...
public class TC6_PurchaseProduct extends BaseTests {
    ...
    public void testPurchaseProduct(){
        ...
        String[] accData = {"ahmed.hesham.mostafa79@gmail.com", "93827155aa"};
        ...
        int shipCostInit = strMgrObj.extractNum(expectedShipCost);
        /* To extract the number 5 from the shipping string */
        int shipCostFin = strMgrObj.extractNum(shipping);
        ...
        int subTotInt = strMgrObj.extractNum(subTot);
        /* To extract grand total as an int from grandTot string */
        int grandTotInt = strMgrObj.extractNum(grandTot);
